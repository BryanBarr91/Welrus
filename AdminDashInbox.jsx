...
import { deleteMessage, getMessage } from "services/contactFormService";
...
const AdminDashInbox = (props) => {
  ...
  function handleRemove(id) {
    //   remove item
    deleteMessage(id).then(onSuccesDelete).catch(onGlobalError);
  }

 
  const onSuccesDelete = React.useCallback(() => {
